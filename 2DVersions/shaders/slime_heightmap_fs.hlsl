...
float4 FSMain(VSOut input) : SV_Target {
  ...
  // additive blending -> these heights will stack smoothly where particles
  // overlap health writes into green channel causing change in coloring so we
  // know damage is being spread
