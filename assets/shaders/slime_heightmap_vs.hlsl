...
// even though from this point I have decided to focus on Vulkan and not DX12 anymore
// but for now I keep the DX12 related code until i clean up the whole repository
#ifdef __SPIRV__
